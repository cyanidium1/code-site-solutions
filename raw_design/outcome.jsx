  ...
  return (
    <div className="benefit-visual">
      <div className="benefit-visual-bar">
        <span /><span /><span />
        <span className="url">efedra.com.ua/послуги</span>
      </div>
      <div className="benefit-visual-content">
        <div className="mock-pages">
          <div className="mock-page">
            <div className="mock-page-tag">Стомат.</div>
            <div className="mock-page-thumb" />
            <div className="mock-page-line" />
            <div className="mock-page-line short" />
          </div>
          <div className="mock-page">
            <div className="mock-page-tag">Естетика</div>
            <div className="mock-page-thumb" />
            <div className="mock-page-line" />
            <div className="mock-page-line short" />
          </div>
          <div className="mock-page">
            <div className="mock-page-tag">Інше</div>
            <div className="mock-page-thumb" />
            <div className="mock-page-line" />
            <div className="mock-page-line short" />
          </div>
...
function MockBookingForm() {
  return (
    <div className="benefit-visual">
      <div className="benefit-visual-bar">
        <span /><span /><span />
        <span className="url">efedra.com.ua/запис</span>
      </div>
      <div className="benefit-visual-content">
...
function MockAdmin() {
  return (
    <div className="benefit-visual">
      <div className="benefit-visual-bar">
        <span /><span /><span />
        <span className="url">admin.efedra.com.ua</span>
      </div>
      <div className="benefit-visual-content">
      ...
      <div className="outcome-inner">
        ...
        <div className="recap-pull">
          ...
          <p className="recap-pull-text">
            За <strong>6 місяців</strong> після запуску клініка <em>«Ефедра»</em> отримала
            вимірний приріст заявок з Google і повний контроль над контентом сайту. Це
            типовий результат переробки сайту клініки — перетворення з «візитки без
            заявок» на <em>інструмент</em>, який реально приводить пацієнтів.
          </p>
        </div>

        {/* ─── Two-column directions card ─────────────────────────────────── */}
        <article className="directions">
          <div className="directions-eyebrow">SOLUTION · ARCHITECTURE</div>
          <h3 className="directions-h3">
            Як ми вирішили задачу<br />
            з <em>двома напрямками</em>
          </h3>
          <p className="directions-lede">
            У клієнта було два напрямки: <em>стоматологія</em> і <em>студія краси</em>.
            Ми не стали робити два окремі сайти — це здешевило б проєкт, але роздробило б
            SEO і вдвічі підвищило б вартість підтримки.
          </p>
            ...
            <div className="directions-col">
              ...
              <ul className="directions-list">
                <li>
                  ...
                  <span>одна головна сторінка для клініки <em>в цілому</em></span>
                </li>
                <li>
                  <span className="directions-bullet">●</span>
                ...
                <li>
                  <span className="directions-bullet">●</span>
                  <span>послуги, лікарі і контент розділені <em>за напрямками</em></span>
                </li>
              </ul>
            </div>
            <div className="directions-col">
              ...
              <ul className="directions-list">
                <li>
                  ...
                  <span>не дробити <em>SEO</em> між двома доменами</span>
                </li>
                <li>
                  <span className="directions-check"><CheckIcon /></span>
                  <span>не втрачати трафік на <em>301-редиректах</em></span>
                </li>
                <li>
                  <span className="directions-check"><CheckIcon /></span>
                  <span>чітко розділити напрямки <em>для пацієнта</em></span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <header className="benefits-header">
          ...
          <p className="benefits-sub">
            Не просто «<em>красивий сайт</em>». Інструменти, що реально впливають на
            потік пацієнтів — структура під SEO, онлайн-запис, керована редактором
            адмінка.
          </p>
        </header>
        ...
        <div className="benefit-hero">
          <div className="benefit-hero-stat">
            ...
            <div className="benefit-hero-lbl">зростання потоку заявок після редизайну</div>
            <div className="benefit-hero-src">— за словами власниці клініки «Ефедра»</div>
          </div>
        ...
        <div className="benefit-row">
          ...
          <div className="benefit-text">
            ...
            <ul className="benefit-list">
              <li>
                <span className="directions-check"><CheckIcon /></span>
                <span>розділення на <em>стоматологію</em> і <em>студію краси</em></span>
              </li>
              <li>
                <span className="directions-check"><CheckIcon /></span>
                <span>окремі сторінки під <mark>кожну послугу</mark></span>
              </li>
              <li>
                <span className="directions-check"><CheckIcon /></span>
        ...
        <div className="benefit-row reverse">
          ...
          <div className="benefit-text">
            ...
            <ul className="benefit-list">
              <li>
                <span className="directions-check"><CheckIcon /></span>
                <span>запис у <mark>2 кліки</mark></span>
              </li>
              <li>
                <span className="directions-check"><CheckIcon /></span>
              ...
              <li>
                <span className="directions-check"><CheckIcon /></span>
                <span>інтеграція з <em>CRM</em> / сповіщення</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="benefit-row">
          ...
          <div className="benefit-text">
            ...
            <ul className="benefit-list">
              <li>
                <span className="directions-check"><CheckIcon /></span>
                <span>зміна <em>цін</em> з телефона</span>
              </li>
              <li>
                <span className="directions-check"><CheckIcon /></span>
              ...
              <li>
                <span className="directions-check"><CheckIcon /></span>
                <span>без <mark>постійної оплати</mark> розробнику</span>
              </li>
            </ul>
          </div>
        </div>
...
ReactDOM.createRoot(document.getElementById('root')).render(<Outcome />);
