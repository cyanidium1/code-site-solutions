...
const PATH = "/en/landing";
const URL = pageUrl(PATH);

export const metadata: Metadata = {
  title: CONTENT.metaTitle,
  description: CONTENT.metaDescription,
  alternates: buildAlternates({ locale: "en", uaPath: "/landing" }),
  openGraph: {
    title: CONTENT.metaTitle,
    description: CONTENT.metaDescription,
    type: "website",
...
export default function EnLandingCategoryPage() {
  return (
    <>
      <JsonLd data={jsonLd} />
      <HpHeader />
