    ...
    <>
      ...
      <main>
        ...
        <TeamSection
          ...
          heading={
            <>
              12 человек. Четверых вы будете слышать <em>каждый день</em>.
            </>
          }
          sub="Это ключевое ядро — те, с кем вы будете общаться напрямую: техлид, дизайнер, фронтенд, маркетинг. За ними еще 8 человек в фоновой работе: 4 разработчика, 2 дизайнера, 2 QA-инженера. Вы видите результат — не процесс."
        />
