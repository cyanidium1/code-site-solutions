...
const PRICING_DESCRIPTION = `➤ Сколько стоит сайт в 2026 ✔️ Лендинг от $800 (${uahApprox(800)}) ✔️ Корпоративный от $2 500 ✔️ Магазин от $6 000 ➡ Цена фиксируется в договоре.`;
