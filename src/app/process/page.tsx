...
const STEPS: TimelineStep[] = [
  ...
  },
  {
    ...
    body: (
      <>
        Підписуємо договір — <em>Diia.Sign</em> або PDF з підписом. Ви робите 50% передоплати. На договорі — фіксована сума, фіксований термін, неустойка за зрив з нашої вини.
      </>
    ),
    weDo: {
      heading: "Що робимо ми",
    ...
    deliverable: {
      ...
      items: [
        ...
        <>Право на неустойку <em>30%</em> за зрив термінів</>,
      ],
    },
  },
  {
    ...
    body: (
      <>
        Створюємо макети у <em>Figma</em>. Спершу moodboard, потім головна, далі — внутрішні. 2 повних раунди правок включені. Ви бачите і затверджуєте кожен етап.
      </>
    ),
    weDo: {
      heading: "Що робимо ми",
  ...
  },
  {
    ...
    body: (
      <>
        Пишемо код на <em>Next.js + Sanity</em>. Коммітимо щодня в GitHub. Раз на тиждень — screencast прогресу 3-5 хв. Telegram-чат — щоденний.
      </>
    ),
    weDo: {
      heading: "Що робимо ми",
  ...
  },
  {
    ...
    body: (
      <>
        Прогінаємо <em>60-точковий QA-чек-ліст</em>. Тестуємо на 5 девайсах і 3 браузерах. Запускаємо Lighthouse-аудит. Ви проходите свій 10-точковий чек-ліст і затверджуєте.
      </>
    ),
    weDo: {
      heading: "Що робимо ми",
  ...
  },
  {
    ...
    body: (
      <>
        Міграція на ваш домен. Налаштовуємо Search Console + Analytics + <em>301-redirect</em> зі старого сайту. Ви робите фінальні 50% і отримуєте всі доступи.
      </>
    ),
    weDo: {
      heading: "Що робимо ми",
  ...
  },
  {
    ...
    body: (
      <>
        Виправляємо будь-які баги <em>безкоштовно</em>. Оновлюємо залежності. Консультуємо. Якщо щось зламалося не з вашої вини — фіксимо за 4 робочі години в робочий час.
      </>
    ),
    weDo: {
      heading: "Що робимо ми",
