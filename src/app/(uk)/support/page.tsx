...
const SUPPORT_FAQ: { q: string; a: RichText }[] = [
  // GSC Aug 2026: «адміністрування сайту ціна» — 28 показів на позиції 27.9,
  // при тому що слова «адміністрування» на сторінці не було взагалі.
  {
    q: "Скільки коштує адміністрування сайту?",
    a: [
      "Адміністрування — це та ж підтримка, просто інша назва: оновлення контенту, правки на сторінках, стежимо за оновленнями й бекапами. Ціна та сама — ",
      { em: "від $200/міс на retainer або $40/год за разовими задачами" },
      ". Якщо змін небагато і вони нерегулярні, погодинна схема виходить дешевшою; якщо контент оновлюється щотижня — вигідніший місячний пакет.",
    ],
  },
  {
  ...
  },
  {
    ...
    a: [
      "Так, після аудиту сайту ($150): дивимось код, хостинг, залежності і чесно кажемо, що можна підтримувати, а що дешевше переписати. Сайти на конструкторах (Tilda, Wix) не обслуговуємо — там немає доступу до коду.",
    ],
  },
  {
      ...
      <Bento
        ...
        cells={[
          ...
          },
          {
            icon: Search,
            title: "Аудит сайту",
            body: "Для сайтів чужої розробки: година розбору коду, хостингу і залежностей перед взяттям на підтримку. Запис і PDF — ваші.",
            stat: "$150",
            span: "1x1",
          },
          {
        ...
        <div className="max-w-container mx-auto">
          ...
          <div className="mt-6 max-w-[760px] font-sans text-[15.5px] leading-[1.7] text-ink-dim space-y-4">
            ...
            <p className="m-0">
              ...
              робив хтось інший — почнемо з аудиту сайту за $150:
