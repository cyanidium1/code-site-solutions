    ...
    <>
      ...
      <main>
        ...
        <TeamSection
          ...
          heading={
            <>
              Команда з 4 людей. З кожним ви говорите <em>напряму</em>.
            </>
          }
          sub="Федір Алпатов — засновник і техлід. З ним дизайнер, розробник і редактор. Без акаунт-менеджерів між вами і тими, хто робить сайт."
        />
