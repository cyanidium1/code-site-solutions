      ...
      <section className="bg-bg px-6 sm:px-8 lg:px-12 py-14">
        <div className="max-w-container mx-auto">
          <h2 className="m-0 font-actay uppercase font-bold text-[clamp(22px,2.6vw,34px)] leading-[1.15] text-ink">
            З чого складається проєкт для медичного закладу
          </h2>
          <div className="mt-6 max-w-[760px] font-sans text-[15.5px] leading-[1.7] text-ink-dim space-y-4">
            <p className="m-0">
              Найважче в сайті медичного центру — не дизайн, а інформаційна
              архітектура. Двадцять лікарів, вісім відділень, сотні послуг і
              аналізів мають скластися в структуру, де пацієнт за два кліки
              знаходить своє: з головної — у відділення, з відділення — до
              лікаря, від лікаря — у вільний слот запису. Ми починаємо саме з
              цього: карта сторінок, шляхи пацієнтів, точки запису — і лише
              потім макети.
            </p>
            <p className="m-0">
              Другий пласт — довіра і відповідність. Медичний контент має свої
              правила: що можна обіцяти, як показувати результати, як
              оформлювати ціни на медичні послуги. Ми пишемо тексти відділень і
              послуг разом із вашими лікарями: ми відповідаємо за структуру і
              мову, вони — за медичну точність. Персональні дані пацієнтів
              живуть в окремому контурі: шифрування, журнал доступів, сервери в
              ЄС і DPA в договорі.
            </p>
            <p className="m-0">
