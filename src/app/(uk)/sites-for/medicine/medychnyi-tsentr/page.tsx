...
const DESCRIPTION =
  "➤ Замовити створення сайту для медичного центру ✔️ Відділення і каталог лікарів ✔️ Онлайн-запис ✔️ Захист даних пацієнтів ✔️ Запуск за 4–6 тижнів ➡ Безкоштовний прорахунок.";
