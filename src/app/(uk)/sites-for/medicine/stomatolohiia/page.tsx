      ...
      <section className="bg-bg px-6 sm:px-8 lg:px-12 py-14">
        <div className="max-w-container mx-auto">
          ...
          <div className="mt-6 max-w-[760px] font-sans text-[15.5px] leading-[1.7] text-ink-dim space-y-4">
            <p className="m-0">
              Перший тиждень — структура. Ми розбираємо ваші послуги на
            ...
            <p className="m-0">
              Другий-третій тиждень — дизайн і тексти. Стоматологія — ніша, де
              ...
              потрібна година, не тиждень.
            </p>
            <p className="m-0">
              Четвертий тиждень — код, інтеграції і запуск: підключаємо
