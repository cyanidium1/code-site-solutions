...
const MED_SEO_FAQ: { q: string; a: RichText }[] = [
  ...
  },
  {
    ...
    a: [
      "Двома речами. Перша — половина результату лежить не на сайті, а в локальному пошуку: картка в Google, відгуки, «стоматолог + район». Друга — медицина належить до YMYL-тематик, де Google жорсткіше дивиться на авторство: сторінка про лікування має бути підписана лікарем із вказаною спеціальністю й досвідом, інакше вона програє навіть при кращій техніці. Сама техніка при цьому теж має бути в порядку — за неї відповідає ",
      { link: { href: "/sites-for/medicine/verstka", text: "верстка і фронтенд" } },
      ".",
    ],
  },
  {
