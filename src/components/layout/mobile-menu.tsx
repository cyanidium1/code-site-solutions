...
// Burger button — visible below 1100px (xl breakpoint; the glass-pill header
// runs burger mode through tablet — see header-classes.ts breakpoint note).
// Mobile-first: shown by default, hidden at xl+.
const burgerBtnClass =
  "inline-flex items-center justify-center w-11 h-11 -mr-2.5 p-0 border-0 bg-transparent text-ink cursor-pointer rounded-ctl transition-colors duration-150 hover:bg-[oklch(1_0_0/0.06)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent-soft focus-visible:outline-offset-2 xl:hidden";
