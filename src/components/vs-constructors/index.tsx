...
type PatternRow = { metric: string; before: string; after: string };
...
const UK: Content = {
  ...
  pricing: {
    ...
    foot: (
      <>
        Усі тири включають: 301-редіректи з усіх старих URL, перенесення
...
const CONTENT: Record<VcLocale, Content> = { uk: UK, en: EN };
