...
const COPY: Record<Locale, { eyebrow: string; title: string; body: string; link: string; alt: string }> = {
  uk: {
    ...
    body: "Федір Алпатов, засновник і техлід. Команда з 4 людей: техлід, дизайнер, розробник, редактор. На брифі, у Telegram і в коді — одна й та сама людина.",
  ...
  ru: {
    ...
    body: "Федор Алпатов, основатель и техлид. Команда из 4 человек: техлид, дизайнер, разработчик, редактор. На брифе, в Telegram и в коде — один и тот же человек.",
  ...
  en: {
    ...
    body: "Fedir Alpatov, founder and tech lead. A team of four: tech lead, designer, developer, editor. The same person on the brief call, in chat and in the code.",
