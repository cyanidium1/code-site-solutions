...
const RU: ProofCopy = {
  ...
  designHeading: (
    <>
      «Дизайн, который продаёт» — это не слова, <em>а решения:</em>
    </>
  ),
  bullets: [
  ...
  footnote: (
    <>
      ...
      значит выше конверсия и лучшие позиции в поиске.
    </>
  ),
};

const COPY_BY_LOCALE: Record<Locale, ProofCopy> = { uk: UK, en: EN, ru: RU };
