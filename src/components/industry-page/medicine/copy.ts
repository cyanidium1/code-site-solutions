...
export const MED_COPY: Record<Locale, MedCopy> = {
  uk: {
    flow: {
      ...
      stepMeta: "КРОК 01 → 05",
      // SEO system 2026-09-15: був «Веб-дизайн для медичних сайтів: …» — хаб
      // забирав дизайн-інтент у /sites-for/medicine/dyzain. Дизайн лишився
      // посиланням у блоці підсторінок нижче.
      heading: "Від пошуку до запису:\nпʼять кроків пацієнта на сайті клініки",
