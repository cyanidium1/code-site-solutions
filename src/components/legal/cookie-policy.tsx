...
const tableClass =
  "w-full mt-4 border-collapse text-[13.5px] leading-[1.5] [&_th]:text-left [&_th]:font-mono [&_th]:text-[12px] [&_th]:tracking-[0.06em] [&_th]:uppercase [&_th]:text-ink-3 [&_th]:pb-2 [&_td]:py-2.5 [&_td]:pr-4 [&_td]:border-t [&_td]:border-line [&_td]:text-ink-dim [&_td:first-child]:text-ink [&_td:first-child]:font-mono [&_td:first-child]:text-[12.5px]";
