...
const TEAM_MEMBERS: TeamMember[] = [
  {
    ...
    shortDescription:
      "Будує складні веб-системи під бізнес-задачі. Перекладає маркетингові ідеї у працюючий код.",
    fullDescription: [
  ...
  },
  {
    ...
    shortDescription:
      "Проєктує інтерфейси, які виглядають дорого і ведуть користувача до дії.",
    fullDescription: [
  ...
  },
  {
    ...
    image: "/team/olga.jpg",
    shortDescription:
      "Доводить інтерфейси до стану, коли все працює швидко, стабільно і без компромісів.",
    fullDescription: [
  ...
  },
  {
    ...
    shortDescription:
      "Будує SEO та B2B-стратегії, які приводять не просто трафік, а клієнтів.",
    fullDescription: [
