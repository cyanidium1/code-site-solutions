  ...
  return (
    <section className="relative px-6 py-8 bg-bg lg:p-12">
      <div className="max-w-container mx-auto">
        <div className="flex flex-wrap items-center gap-3.5 px-[18px] py-4 border border-line rounded-card w-full max-w-full bg-[oklch(1_0_0_/_0.02)] backdrop-blur-[8px] lg:flex-nowrap lg:gap-6 lg:px-7 lg:py-5">
          {items.map((it, i) => (
            <div
              key={i}
              className={cn(
