    ...
    <section className="relative py-[72px] lg:py-[120px] px-[18px] sm:px-8 xl:px-12 bg-bg overflow-hidden">
      ...
      <div className="relative z-[2] max-w-container mx-auto">
        <header className="grid grid-cols-1 gap-4 items-start mb-9 pb-5 border-b border-line sm:grid-cols-[minmax(0,1fr)_auto] sm:gap-8 sm:items-end sm:mb-14 sm:pb-6 xl:gap-10 xl:mb-[72px] xl:pb-8">
          ...
          <div className="font-mono text-[11px] text-[var(--ink-3)] tracking-[0.04em] text-left whitespace-nowrap pb-2 sm:text-right">
            {metaRows.map((row, i) => (
              <div
                className={cn(
            ...
            return (
              ...
              >
                <header className="flex items-start justify-between gap-4">
                  ...
                  <span className="font-mono text-[9px] font-medium text-[var(--ink-3)] tracking-[0.08em] px-2.5 py-1 border border-line rounded-full bg-[oklch(1_0_0_/_0.02)] shrink-0 sm:text-[10px]">
                    {r.tag}
                  </span>
                </header>
                ...
                <footer className="flex items-baseline gap-4 pt-4 border-t border-dashed border-line">
                  ...
                  {r.stat.src ? (
                    <div className="font-mono text-[9px] text-[var(--ink-3)] tracking-[0.06em] uppercase shrink-0 hidden sm:block">
                      {r.stat.src}
                    </div>
                  ) : null}
                </footer>
        ...
        <div className="flex flex-col items-stretch gap-4 flex-wrap mt-8 p-[18px] border border-line rounded-[18px] bg-[oklch(1_0_0_/_0.02)] sm:flex-row sm:items-center sm:justify-between sm:gap-6 sm:mt-12 sm:py-[22px] sm:px-7 sm:rounded-full">
          <div className="text-[13px] text-[var(--ink-2)] flex items-center justify-center text-center gap-3 [&_strong]:text-ink [&_strong]:font-semibold sm:text-[14px] sm:justify-normal sm:text-start">
