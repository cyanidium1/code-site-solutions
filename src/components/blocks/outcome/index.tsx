...
const BENEFIT_LIST =
  "flex flex-col gap-3 [&>li]:flex [&>li]:items-start [&>li]:gap-3 [&>li]:text-[13px] [&>li]:leading-[1.55] [&>li]:text-[var(--ink-2)] [&>li_em]:not-italic [&>li_em]:text-ink [&>li_em]:font-medium [&>li_mark]:bg-[oklch(from_var(--accent)_l_c_h_/_0.18)] [&>li_mark]:text-accent-soft [&>li_mark]:px-1.5 [&>li_mark]:py-px [&>li_mark]:rounded [&>li_mark]:font-medium md:[&>li]:text-[14px]";
  ...
  return (
    <section className="relative py-14 lg:py-[100px] px-[18px] md:px-8 xl:px-12 bg-bg overflow-hidden">
      ...
      <div className="relative z-[2] max-w-container mx-auto">
        ...
        {/* Directions card */}
        <article className="relative border border-[var(--line-2)] rounded-[18px] bg-[linear-gradient(180deg,oklch(1_0_0_/_0.02),oklch(1_0_0_/_0.005))] px-5 py-6 mb-14 overflow-hidden md:p-8 md:mb-20 md:rounded-3xl xl:pt-11 xl:px-12 xl:pb-11 xl:mb-[120px] before:content-[''] before:absolute before:top-0 before:right-0 before:w-[200px] before:h-[200px] before:pointer-events-none before:bg-[radial-gradient(circle_at_top_right,oklch(from_var(--accent)_l_c_h_/_0.12),transparent_70%)]">
          ...
          <p className="text-[14px] leading-[1.7] text-[var(--ink-2)] mb-[26px] max-w-[70ch] md:text-[15px] md:mb-9 [&_em]:not-italic [&_em]:text-ink [&_em]:font-medium">
            {directionsLede}
          </p>
          <div className="grid grid-cols-1 gap-7 pt-[22px] border-t border-dashed border-line md:grid-cols-2 md:gap-8 md:pt-7 xl:gap-12">
            <div>
              ...
              <ul className="list-none flex flex-col gap-3 [&>li]:flex [&>li]:items-start [&>li]:gap-3 [&>li]:text-[13px] [&>li]:leading-[1.55] [&>li]:text-[var(--ink-2)] [&>li_em]:not-italic [&>li_em]:text-ink [&>li_em]:font-medium md:[&>li]:text-[14px]">
        ...
        <header className="mb-10 pb-[22px] border-b border-line grid grid-cols-1 gap-6 items-start xl:mb-14 xl:pb-7 xl:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] xl:gap-14 xl:items-end">
          ...
          <p className="text-[14px] leading-[1.65] text-[var(--ink-2)] text-pretty pb-2 md:text-[15px] [&_em]:not-italic [&_em]:text-ink [&_em]:font-medium">
            {benefitsSub}
          </p>
        </header>
        ...
        {(benefitHeroValue || benefitHeroLede || benefitHeroBullets.length > 0) ? (
          <div className="grid grid-cols-1 gap-[22px] items-center px-[22px] py-6 mb-8 border border-[oklch(from_var(--accent)_l_c_h_/_0.35)] rounded-[18px] bg-[linear-gradient(135deg,oklch(from_var(--accent)_l_c_h_/_0.10),oklch(from_var(--accent-2)_l_c_h_/_0.06)_60%,transparent)] relative overflow-hidden shadow-[0_30px_60px_oklch(from_var(--accent)_l_c_h_/_0.18)] md:gap-7 md:p-8 md:rounded-3xl xl:grid-cols-2 xl:gap-12 xl:py-11 xl:px-12 before:content-[''] before:absolute before:top-[-40%] before:right-[-20%] before:w-[60%] before:h-[180%] before:pointer-events-none before:bg-[radial-gradient(ellipse_at_center,oklch(from_var(--accent)_l_c_h_/_0.18),transparent_70%)]">
