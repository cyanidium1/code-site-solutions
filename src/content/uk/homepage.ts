...
export const HOMEPAGE_UK: HomepageContent = {
  ...
  hero: {
    h1Line1: "Сайт під ключ кодом",
    h1Line2Lead: `за ${D} днів `,
    h1Line2Em: `від ${BUSINESS}`,
    lede: "Без підписок і конструкторів. Код, домен і дані — ваші. Гарантія рік і все включено.",
    features: [
      {
        label: "ТЗ пишемо самі",
        sub: "Без брифів на 50 запитань: рішення і аргументи наші",
      },
      {
        label: "Гарантія 1 рік",
        sub: "Без підписок і прив'язки: код ваш, підете будь-коли",
      },
    ],
