...
export const PRICING_FAQ: { q: string; a: RichText }[] = [
  {
    ...
    a: [
      "Лендінг — ",
      { em: "від $800" },
      ", корпоративний сайт — від $3 500, кастомна платформа — від $6 000. Це фіксовані пакети: сума прописується в договорі до старту і не зростає в процесі. Швидку вилку під ваш проєкт дає ",
  ...
  },
  {
    ...
    a: [
      "Залежить від трьох речей: обсягу сторінок, кількості інтеграцій (CRM, оплата, запис) і мов. Односторінковий лендінг стартує з $800, сайт компанії з CMS — з $3 500. На ціну майже не впливає дизайн — він кастомний у кожному пакеті.",
    ],
  },
  {
