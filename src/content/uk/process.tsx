...
export const PROCESS_FAQ: { q: string; a: RichText }[] = [
  ...
  },
  {
    ...
    a: [
      { em: "1 рік гарантії" },
      ": виправлення багів і дрібні правки безкоштовно. Нові фічі — $40/год або monthly retainer $200-500/міс. Великий редизайн — окремий проект з фіксованою ціною. Деталі й пакети — на сторінці ",
      { link: { href: "/support", text: "обслуговування сайту: вартість" } },
      ".",
    ],
  },
  {
  ...
  },
  {
    ...
    a: [
      "Можемо порекомендувати копірайтера (від $30/стаття) або взяти контент-наповнення на себе (",
      { em: "$300-500/блок" },
