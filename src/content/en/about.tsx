  ...
  projects: {
    ...
    items: [
      ...
      },
      {
        ...
        meta: "Services · Ukraine",
        blurb:
          "A site for a services agency across SEO, AI, CRM, web and media — 4 service packages, an interactive AI demo and a clear inquiry-generation structure.",
        tags: ["Next.js", "Lead-gen"],
        href: "/en/portfolio/clarion-solutions",
