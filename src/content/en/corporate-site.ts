...
export const CORPORATE_EN: LandingPageContent = {
  ...
  miniCalc: {
    ...
    options: [
      { id: "premium", label: "Premium design with custom artwork", price: 1000 },
      { id: "payments", label: "Online payments (Stripe / GoCardless)", price: 900 },
      { id: "booking", label: "Booking / time slots", price: 600 },
  ...
  priceTable: {
    ...
    rows: [
      ...
      ["Service business with booking", "base + booking + online payments", "£4,000", "6–8 weeks"],
      ["10-page services site", "base + 5 pages for separate directions", "£3,600", "6–8 weeks"],
      ["Fully loaded", "10 pages, 3 languages, payments, booking, industry integration, SEO pack", "£5,800", "8 weeks"],
    ],
