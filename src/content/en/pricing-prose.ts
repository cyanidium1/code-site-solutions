...
export const PRICING_PROSE_EN: ProseSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "These are three different products for different jobs. The point-by-point comparison lives on its own pages:",
    ],
    links: [
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ["Renovation, construction", "work portfolio, calculator, survey request form", "from £2,500", "from 4 weeks"],
      ],
    },
