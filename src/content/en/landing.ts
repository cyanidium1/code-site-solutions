...
export const LANDING_EN: LandingPageContent = {
  ...
  miniCalc: {
    ...
    blocks: {
      ...
      note: "+£150 per section beyond 7",
      unitPrice: 150,
      max: 5,
    },
    options: [
      { id: "telegram", label: "Leads to Telegram", price: 150 },
      { id: "lang", label: "Second language", price: 120 },
      { id: "brand", label: "Branded design with animation", price: 160 },
      { id: "crm", label: "CRM integration", price: 500 },
      { id: "booking", label: "Booking / time slots", price: 600 },
      { id: "payments", label: "Online payments (Stripe / GoCardless)", price: 900 },
      { id: "express", label: "Skip-the-queue launch in 7 days", price: 700 },
    ],
