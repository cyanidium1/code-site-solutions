...
export function calculatorPage(l: Locale): CalculatorPage {
  ...
  if (l === DEFAULT) {
    return {
      ...
      faqHeading: "Питання про калькулятор",
      faq: [
      ...
      prose: [
        {
          // Не «ціна сайту» і не «скільки коштує»: за цими запитами Google
          // ставив калькулятор замість /pricing на 65–97 позиції, а /pricing
          // отримував 1 клік на 1 660 показів. Калькулятор лишається під
          // запит «калькулятор», ціна живе на /pricing (ANALYTICS-2026-09-22 §1.5).
          eyebrow: "ЯК РАХУЄ КАЛЬКУЛЯТОР",
          heading: ["Як калькулятор ", "складає суму"],
          ...
          links: [{ label: "скільки коштує зробити сайт — усі ціни", href: "/pricing" }],
        },
      ],
    };
  }
  ...
  if (l === "ru") {
    return {
      ...
      faqHeading: "Вопросы о калькуляторе",
      faq: [
      ...
      prose: [
        {
          eyebrow: "КАК СЧИТАЕТ КАЛЬКУЛЯТОР",
          heading: ["Как калькулятор ", "складывает сумму"],
          ...
          links: [{ label: "сколько стоит сделать сайт — все цены", href: "/ru/pricing" }],
        },
      ],
    };
  }
